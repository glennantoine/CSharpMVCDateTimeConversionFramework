...
{
    public class TimeGreaterThanEqualAttributeValidation : ValidationAttribute, IClientValidatable
    {
        ...
        public TimeGreaterThanEqualAttributeValidation( string basePropertyName ) : base(DefaultErrorMessage)
        {  
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            rule.ValidationType = "timegreaterthanequal";
