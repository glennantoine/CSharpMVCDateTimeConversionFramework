...
namespace CustomModelBindingWithDateTime.Models.ValidationAttributes
{
    ...
    public class UiDateTimeTimeGreaterThanAttributeOrNullValidation : ValidationAttribute, IClientValidatable
    {
        ...
        public UiDateTimeTimeGreaterThanAttributeOrNullValidation(string basePropertyPath, string comparisonPropertyPath, bool allowEqual = true)
