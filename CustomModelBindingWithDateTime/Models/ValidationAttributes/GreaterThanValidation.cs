...
{
    public class GreaterThanAttributeOrNullValidation : ValidationAttribute, IClientValidatable
    {
        ...
        public GreaterThanAttributeOrNullValidation(string basePropertyName)
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            if (value != null)
            {
                ...
                var firstVal = Convert.ToInt64(propValue.ToString());

                var thisVal = Convert.ToInt64(value.ToString());
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            rule.ValidationType = "greaterthanattributeornull";
