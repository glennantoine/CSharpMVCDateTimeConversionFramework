...
namespace CustomModelBindingWithDateTime.Tests.Models 
{
    ...
    public class UiDateTimeModelTest 
    {
        ...
        public void TestUiDateTimeModelWithLocalTimeOnlyPasses() 
        {
            ...
            Assert.AreEqual(DateTime.Parse("01/01/0001 9:00:00 PM"), testUiDateTimeModel.DateTimeLocalValue);
            Assert.AreEqual(DateTime.Parse("01/01/0001 9:00:00 PM").ToUniversalTime(timeZoneId), testUiDateTimeModel.DateTimeUtcValue);
        }
