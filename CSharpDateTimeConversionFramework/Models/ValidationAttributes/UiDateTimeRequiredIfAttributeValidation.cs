...
namespace CSharpDateTimeConversionFramework.Models.ValidationAttributes
{
    ...
    public class UiDateTimeRequiredIfAttributeValidation : ValidationAttribute, IClientValidatable
    {
        ...
        public UiDateTimeRequiredIfAttributeValidation(string basePropertyPath, string comparisonPropertyPath)
            ...
            var rule = new ModelClientValidationRule
                           {
                               ...
                               ValidationType = "uidatetimerequiredifattribute" + _basePropertyPath.ToLower().Replace(".", "")
                           };
